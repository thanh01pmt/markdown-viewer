...
const dropdowns = {};
const ignorelt: string[] = [];
const soundEffects = ["cao độ", "pan trái/phải"];
const microbitWhen = ["moved", "shaken", "jumped"];
const osis = ["other scripts in sprite"];
const definePrefix = ["định", "nghĩa"];
const defineSuffix: string[] = [];
const palette = {
  Motion: "Chuyển động",
  Looks: "Hiển thị",
  Sound: "Âm thanh",
...
export default function initTranslations(scratchblocks: any) {
  const languages = { vi } as Record<string, any>;
  if (scratchblocks && typeof scratchblocks.loadLanguages === 'function') {
