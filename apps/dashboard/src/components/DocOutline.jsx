...
export function DocOutline({ content, scrollContainerRef, isDialog, onClose }) {
  ...
  const inner = (
    <div className="outline-inner doc-outline-inner">
  ...
  return (
    <div className="lesson-outline doc-outline">
      {inner}
    </div>
  );
}
